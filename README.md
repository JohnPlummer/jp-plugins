...
> **Status: scaffold (Phase 0).** Structure is in place; the phases are being built. See the implementation plan in the authoring vault project `Dev Workflow Plugin`.
