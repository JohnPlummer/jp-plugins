...
{Describe how the implementation of/compliance with the ADR can/will be confirmed. E.g. by a review or an automated test. Is the chosen design and its implementation in line with the decision?}
